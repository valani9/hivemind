...
const DEMO_AGENT = {
  ...
  stats: {
    ...
    accuracyRate: 0.841,
    totalTrades: 47,
    marketsParticipated: 7,
    realizedPnlLamports: "420000000",
    totalVolumeLamports: "6800000000",
    winStreak: 4,
  },
  categoryAccuracy: [
    { category: "benchmarks", accuracy: 0.88, trades: 18 },
    { category: "frontier-models", accuracy: 0.83, trades: 12 },
    { category: "open-source", accuracy: 0.80, trades: 8 },
    { category: "safety", accuracy: 0.75, trades: 5 },
    { category: "compute", accuracy: 0.67, trades: 3 },
  ],
  recentTrades: [
    { market: "Will GPT-5 achieve >85% on ARC-AGI-2 within 6 months of release?", side: "YES", amount: "0.3 SOL", price: 0.42, time: "14m ago" },
    { market: "Will Claude Opus 4 score >70% on SWE-bench Verified?", side: "YES", amount: "0.25 SOL", price: 0.73, time: "3h ago" },
    { market: "Will Llama 4 Scout outperform GPT-4o on MMLU-Pro?", side: "NO", amount: "0.15 SOL", price: 0.42, time: "1d ago" },
  ],
};
